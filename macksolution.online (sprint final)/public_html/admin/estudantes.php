...
$sql_3 = "UPDATE estudantes SET serie = '$serie', turno = '$turno', obs = '$obs' WHERE code = '$code'";
...
<form name="form1" method="post" action="">
  <table width="900" border="0">
    <tr>
      <td width="350">Curso que este aluno vai se matricular:</td>
...
<ul>
 <li>Para fazer o Login no sistema com este Aluno você deve usar o Código do Aluno e seu CPF!</li>
