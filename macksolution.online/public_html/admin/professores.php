...
$sql_2 = "UPDATE professores SET nome = '$nome', cpf = '$cpf', nascimento = '$nascimento', formacao = '$formacao', graduacao = '$graduacao', pos_graduacao = '$pos_graduacao', mestrado = '$mestrado' WHERE id = '$id'";
...
<h1>Cadastrar novo professor 
  <a href="javascript:history.back()" style="float: right; margin-right: 20px; margin-bottom: 15px; "><button style="cursor:pointer" class="input" id="button" >Voltar</button></a> 
</h1>
<?php if(isset($_POST['button'])){
...
$sql_2 = "INSERT INTO professores (code, status, nome, cpf, nascimento, formacao, graduacao, pos_graduacao, mestrado) VALUES ('$code', 'Ativo', '$nome', '$cpf', '$nascimento', '$formacao', '$graduacao', '$pos_graduacao', '$mestrado')";
